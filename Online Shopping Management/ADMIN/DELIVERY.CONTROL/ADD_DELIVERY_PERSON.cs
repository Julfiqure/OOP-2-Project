...
{
    public partial class ADD_DELIVERY_PERSON : Form
    {
        ...
        private void ADD_DELIVERY_PERSON_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand sq5 = new SqlCommand("select * from TEMPORARYDELIVERYPERSONTABLE", con);
            ...
            try
            {
                ...
                if (dt1.Rows.Count > 0 && dt2.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        SqlCommand sq1 = new SqlCommand("INSERT INTO DELIVERYPERSONTABLE SELECT * FROM TEMPORARYDELIVERYPERSONTABLE WHERE DELIVERY_PERSON_ID='" + textBox1.Text + "'", con);
                        // sq1.Parameters.AddWithValue("@SELLER_ID", (textBox1.Text));

                        sq1.ExecuteNonQuery();
                        SqlCommand sq3 = new SqlCommand("delete from TEMPORARYDELIVERYTABLE where DELIVERY_PERSON_ID='" + textBox1.Text + "'", con);
                        //sq3.Parameters.AddWithValue("@SELLER_ID", (textBox1.Text));

                        sq3.ExecuteNonQuery();
                        con.Close();

                        MessageBox.Show("DELIVERY PERSON ADDED.");
                        textBox1.Clear();
                        textBox2.Clear();
                ...
                {
                    MessageBox.Show("INVALID ADMIN PASSWORD or DELIVERY PERSON ID.!!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    textBox1.Clear();
                    textBox2.Clear();
                    //textBox1.Focus();
                }
