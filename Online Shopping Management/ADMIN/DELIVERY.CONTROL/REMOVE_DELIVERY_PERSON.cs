...
{
    public partial class REMOVE_DELIVERY_PERSON : Form
    {
        public REMOVE_DELIVERY_PERSON()
        {
            InitializeComponent();
        }
        ...
        private void REMOVE_DELIVERY_PERSON_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand sq5 = new SqlCommand("select * from DELIVERYPERSONTABLE", con);
            ...
            try
            {
                ...
                if (dt1.Rows.Count > 0 && dt2.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        SqlCommand sq3 = new SqlCommand("delete from DELIVERYPERSONTABLE where DELIVERY_PERSON_ID='" + textBox1.Text + "'", con);

                        sq3.ExecuteNonQuery();
                        con.Close();

                        MessageBox.Show("DELIVERY PERSON REMOVED.");
                        textBox1.Clear();
                        textBox2.Clear();
