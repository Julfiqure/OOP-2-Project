...
{
    public partial class CHECK_DELIVERY_STATUS : Form
    {
        public CHECK_DELIVERY_STATUS()
        {
            InitializeComponent();
        }
        ...
        private void CHECK_DELIVERY_STATUS_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    {
                        SqlCommand sq4 = new SqlCommand("select * from DELIVERYPERSONTABLE where DELIVERY_PERSON_ID='" + textBox1.Text + "'", con);
